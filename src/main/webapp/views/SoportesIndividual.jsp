                ...
                <div class="col-xs-12 col-md-6 col-lg-8 col-lg-offset-2"> 
                    ...
                    <div class="x_content">  
                        <div id="wizard" class="form_wizard wizard_horizontal">
                            ...
                            <div id="step-1" class="col-md-10 col-sm-10 col-xs-12 col-lg-10 col-md-offset-4 col-lg-offset-2">                  		    		
                                <div class="row">
                                    <div class="col-sm-11 col-lg-12 col-sm-offset-3 col-lg-offset-0">
                                        <br>	
                                        <span><strong>DOCUMENTO  RECIBO PUBLICO <label  style="color: red;">*</label></strong></span><br>
                                    ...
                                    <div class="col-sm-11 col-lg-12 col-sm-offset-3 col-lg-offset-0">	
                                        <span><strong>FOSYGA <label  style="color: red;">*</label></strong></span><br>
                                    ...
                                    <div class="col-sm-11 col-lg-12 col-sm-offset-3 col-lg-offset-0">	
                                        <span><strong>REGISTRO CIVIL DE LOS HIJOS <label  style="color: red;">*</label></strong></span><br>
                            ...
                            <div id="step-2" class="col-md-10 col-sm-10 col-xs-12 col-lg-10 col-md-offset-4 col-lg-offset-2">
                                <div class="row">
                                    <div class="col-sm-11 col-lg-12 col-sm-offset-3 col-lg-offset-0">
                                        <br>
                                        <span><strong>DOCUMENTO RECIBO IMPUESTO PREDIAL <label  style="color: red;">*</label></strong></span><br>
                            ...
                            <div id="step-3" class="col-md-10 col-sm-10 col-xs-12 col-lg-10 col-md-offset-4 col-lg-offset-2">
                                <div class="row">
                                    <div class="col-sm-11 col-lg-12 col-sm-offset-3 col-lg-offset-0">
                                        <br>
                                        <span><strong>CERTIFICADO DE INGRESOS <label  style="color: red;">*</label></strong></span><br>
                                    </div>
                                </div>
                            </div>
